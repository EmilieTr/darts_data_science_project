explanation_5 = """This research question was asked under the assumption, that while the sport develops and becomes 
...
first_graph_5 = """The number of participants grew from 24 to 96 players, with significant expansions occurring 
...
the higher the increase of prize money - in particular since 2010. So the difference from the last 96 placements to
the first place increased a lot."""