...
at the end of the year or the relative values which shows the ratio of the absolute number to the total number
of player and rankings shown."""
...
Right-handed players dominate the rankings, suggesting that left-handed players are either less common."""
