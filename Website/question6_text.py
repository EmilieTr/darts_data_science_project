...
first_description_6 = """This graph shows the player's age demographics related to their rankings. The bigger the bubble, the more players belong to 
that demographic. (Sara, pls help with the legend)"""
...
second_description_6 = """This graph shows the player's nationality demographics related to their rankings. The bigger the bubble, the more players
belong to that demographic. (Sara, pls help with the legend)"""
...
third_description_6 = """This graph shows the player's right-/left-handedness demographics related to their rankings. The bigger the bubble, the more players
belong to that demographic. (Sara, pls help with the legend)"""
